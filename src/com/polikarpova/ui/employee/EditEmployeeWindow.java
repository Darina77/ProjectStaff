...
import com.polikarpova.repository.PositionRepository;
...
public class EditEmployeeWindow {
    ...
    public EditEmployeeWindow(DepartmentWindow mainWindow, PositionRepository positionRepository, DepartmentRepository departmentRepository, int selectedEmployeeId) {
    ...
    private void initialize() {
        frame = new JFrame();
        frame.setTitle("Перепризначити співробітника до відділу");
    ...
    private JButton createSubmitButton(JComboBox departmentIdField, JTextField descriptionField, JTextField salaryField) {
        submitButton = new JButton("Перепризначити");
        ...
        submitButton.addActionListener(e -> {
            try {
                ...
                positionRepository.updatePosition(description, salary, selectedDepartmentId, selectedEmployeeId);

                message.setText("Перепризначено!");
